...
const TEXTS = {
  CODE_NOT_FOUND: { title: '唯一码不存在', hint: '请检查链接是否完整、是否复制有误。' },
  CODE_EXPIRED: { title: '无效的唯一码', hint: '该唯一码已失效（收码结果保留期已满）。' },
  CODE_EXHAUSTED: { title: '配额已用尽', hint: '该唯一码的收码次数已全部用完。' },
  CODE_REVOKED: { title: '唯一码已吊销', hint: '该唯一码已被管理员停用，请联系发放方。' },
  ...
  RENEW_LIMIT: { title: '重申请次数已达上限', hint: '该唯一码无法再次获取邮箱，请联系发放方。' },
